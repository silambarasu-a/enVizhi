...
export function GoogleButton({ callbackUrl = "/dashboard" }: { callbackUrl?: string }) {
  ...
  return (
    <button
      ...
      className="w-full h-11 inline-flex items-center justify-center gap-2.5 rounded-lg border border-border bg-card text-sm font-medium hover:bg-secondary transition-colors disabled:opacity-60"
    >
      <GoogleLogo />
